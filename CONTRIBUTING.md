...
The following is a set of guidelines for contributing to sonar-branch-plugin, which are hosted in the [Facthunder Organization](https://github.com/facthunder) on GitHub. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
## Code of Conduct
This project and everyone participating in it is governed by the [Facthunder Code of Conduct](CODE_OF_CONDUCT.md). 
...
* If the problem started happening recently, **can you reproduce the problem in an older version?** What's the most recent version in which the problem doesn't happen? You can download older versions from [the releases page](https://github.com/facthunder/sonar-branch-plugin/releases).
